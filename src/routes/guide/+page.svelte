...
<ol class="steps">
	<li>Unity でシーンを開き、Hierarchy でアバターのルートを右クリック → <strong>ILLUSORY OVERRIDE → ReFrame → このアバターに ReFrame を追加</strong>。</li>
...
<ul>
	...
	<li>Inspector の一番上にある「作者ショップの商品紹介」は宣伝の枠で、閉じたままで構いません。開いても設定には影響しません。</li>
</ul>
...
<h2>6. 更新</h2>
<p>新しい版が出ると、Inspector の一番上に「新しい版 X が公開されています」と出ます。「更新ページを開く」で配布ページを開き、unitypackage を Unity に取り込むと入れ替わります。VCC から更新しても構いません。</p>
